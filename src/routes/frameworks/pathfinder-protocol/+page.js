...
export async function load({ depends, url, params }) {
  ...
  if (DEBUG_FRAMEWORK_LOADING) console.log('=== Regenerative Enterprise +page.js load function ===');
  ...
  if (DEBUG_FRAMEWORK_LOADING) console.log('Loading regenerative enterprise sections for locale:', currentLocale);
