...
export async function load({ depends, url, params }) {
  ...
  if (DEBUG_FRAMEWORK_LOADING) console.log('=== Hearthstone Protocol +page.js load function ===');
  ...
  if (DEBUG_FRAMEWORK_LOADING) console.log('Loading hearthstone protocol sections for locale:', currentLocale);
