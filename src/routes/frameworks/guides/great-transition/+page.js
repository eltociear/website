...
export async function load({ depends, url, params }) {
  ...
  if (DEBUG_FRAMEWORK_LOADING) console.log('=== Great Transition Guide +page.js load function ===');
  ...
  if (DEBUG_FRAMEWORK_LOADING) console.log('Loading great transition guide sections for locale:', currentLocale);
