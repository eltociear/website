...
export async function load({ depends, url, params }) {
  ...
  if (DEBUG_FRAMEWORK_LOADING) console.log('=== Regenerative Resources Guide +page.js load function ===');
  ...
  if (DEBUG_FRAMEWORK_LOADING) console.log('Loading regenerative resources guide sections for locale:', currentLocale);
