...
export async function load({ depends, url, params }) {
  ...
  console.log('=== Bioregional Compass Guide +page.js load function ===');
  ...
  console.log('Loading bioregional compass guide top sections for locale:', currentLocale);
  ...
  console.log('Total top sections loaded:', loadedSections, 'out of', topSections.length);
