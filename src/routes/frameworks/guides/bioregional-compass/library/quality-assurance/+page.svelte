<!-- src/routes/frameworks/guides/bioregional-compass/library/quality-assurance/+page.svelte -->
<script>
  ...
  function getCategoryColor(category) {
    switch (category) {
      ...
      case 'measurement': return '#228B22';
      case 'monitoring': return '#FF8C00';
      case 'improvement': return '#9932CC';
      default: return '#6b7280';
    }
  }
...
<svelte:head>
  <title>{getTextWithFallback('guidesBioregionalCompassLibrary.qualityAssurance.title', 'Quality Assurance - Bioregional Compass')}</title>
  <meta name="description" content="{getTextWithFallback('guidesBioregionalCompassLibrary.qualityAssurance.description', 'Comprehensive quality management, metrics systems, and continuous improvement frameworks')}" />
</svelte:head>
...
{#if mounted}
  ...
  <div class="breadcrumb-nav">
    <nav class="breadcrumb-container">
      ...
      <span class="breadcrumb-separator">›</span>
      <span class="breadcrumb-current">Quality Assurance</span>
    </nav>
  </div>
  ...
  <div class="page-container">
    ...
    <header class="page-header">
      ...
      <p class="page-subtitle">
        Comprehensive quality management, metrics systems, and continuous improvement frameworks
      </p>
    </header>
    ...
    <div class="content-layout">
      ...
      <aside class="resource-nav">
        <div class="nav-header">
          <h2 class="nav-title">Quality Systems</h2>
          <p class="nav-subtitle">{data.totalResources} assessment frameworks</p>
        </div>
                ...
                <div class="resource-overview" transition:slide={{ duration: 200 }}>
                  ...
                  <div class="overview-meta">
                    ...
                    <div class="meta-item">
                      ...
                      <span class="meta-value">Quality Framework</span>
                    </div>
                  </div>
        ...
        <div class="resource-content">
          ...
          {:else}
            <div class="no-resource">
              <h3>Select a Quality Framework</h3>
...
{:else}
  ...
  <div class="loading-container">
    ...
    <p>Loading quality assurance resources...</p>
  </div>
{/if}

<style>
  /* Quality Assurance color scheme - measurement/improvement theme */
  :root {
    ...
    --measurement-green: #228B22;
    --monitoring-orange: #FF8C00;
    --improvement-purple: #9932CC;
  }
