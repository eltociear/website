<!-- src/routes/frameworks/guides/bioregional-compass/library/resource-planning/+page.svelte -->
<script>
  ...
  // Component state
  let mounted = false;
  let activeResource = 'overview'; // Start with overview
  let expandedOverviews = new Set(['overview']); // Default expand first
  ...
  function getCategoryColor(category) {
    switch (category) {
      case 'overview': return '#4169E1';
      case 'financial': return '#228B22';
      case 'development': return '#9932CC';
      case 'relationships': return '#8B4513';
      default: return '#6b7280';
    }
  }
...
<svelte:head>
  <title>{getTextWithFallback('guidesBioregionalCompassLibrary.resourcePlanning.title', 'Resource Planning - Bioregional Compass')}</title>
  <meta name="description" content="{getTextWithFallback('guidesBioregionalCompassLibrary.resourcePlanning.description', 'Comprehensive planning tools for financial modeling, capacity building, and partnership development')}" />
</svelte:head>
...
{#if mounted}
  ...
  <div class="breadcrumb-nav">
    <nav class="breadcrumb-container">
      ...
      <span class="breadcrumb-separator">›</span>
      <span class="breadcrumb-current">Resource Planning</span>
    </nav>
  </div>
  ...
  <div class="page-container">
    ...
    <header class="page-header">
      ...
      <p class="page-subtitle">
        Comprehensive planning tools for financial modeling, capacity building, and partnership development
      </p>
    </header>
    ...
    <div class="content-layout">
      ...
      <aside class="resource-nav">
        <div class="nav-header">
          <h2 class="nav-title">Planning Tools</h2>
          <p class="nav-subtitle">{data.totalResources} comprehensive guides</p>
        </div>
                ...
                <div class="resource-overview" transition:slide={{ duration: 200 }}>
                  ...
                  <div class="overview-meta">
                    ...
                    <div class="meta-item">
                      ...
                      <span class="meta-value">Planning Guide</span>
                    </div>
                  </div>
        ...
        <div class="resource-content">
          ...
          {:else}
            <div class="no-resource">
              <h3>Select a Planning Resource</h3>
...
{:else}
  ...
  <div class="loading-container">
    ...
    <p>Loading planning resources...</p>
  </div>
{/if}

<style>
  /* Resource Planning color scheme - business/planning theme */
  :root {
    ...
    /* Category colors */
    --overview-blue: #4169E1;
    --financial-green: #228B22;
    --development-purple: #9932CC;
    --relationships-brown: #8B4513;
  }
