<!-- src/routes/frameworks/guides/bioregional-compass/playbooks/legal-strategy-and-resilience-playbook/+page.svelte -->
<script>
  ...
  function getSectionIcon(sectionId) {
    switch (sectionId) {
      ...
      case 'legal-structure-decision-tree': return '🌳';
      case 'proactive-regulatory-engagment': return '🤝';
      case 'exit-strategy-and-dissolution-protocols': return '📋';
      default: return '⚖️';
    }
  }
...
<svelte:head>
  <title>Legal Strategy & Resilience Playbook - Bioregional Compass</title>
  <meta name="description" content="Comprehensive legal preparation, risk assessment, and resilience strategies for BAZ communities navigating complex regulatory environments" />
</svelte:head>
...
{#if mounted}
  ...
  <div class="breadcrumb-nav">
    <nav class="breadcrumb-container">
      ...
      <span class="breadcrumb-separator">›</span>
      <span class="breadcrumb-current">Legal Strategy & Resilience</span>
    </nav>
  </div>
    ...
    <header class="playbook-header">
      <div class="header-content">
        ...
        <p class="playbook-description">
          Comprehensive legal preparation, risk assessment, and resilience strategies for BAZ communities navigating complex regulatory environments
        </p>
    ...
    <div class="content-layout">
      ...
      <aside class="section-nav" class:expanded={sidebarExpanded}>
        <div class="nav-header">
          <h2 class="nav-title">Playbook Sections</h2>
...
{:else}
  ...
  <div class="loading-container">
    ...
    <p>Loading legal strategy playbook...</p>
  </div>
{/if}

<style>
  /* Legal playbook color scheme */
  :root {
  ...
  /* Playbook Header */
  .playbook-header {
    background: linear-gradient(135deg, var(--guide-light), var(--legal-light));
    border-radius: 1rem;
    padding: 3rem 2rem;
    margin-bottom: 3rem;
