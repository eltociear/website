<!-- src/routes/frameworks/guides/bioregional-compass/playbooks/balancing-innovation-and-tradition/+page.svelte -->
<script>
  ...
  function getSectionIcon(sectionId) {
    switch (sectionId) {
      ...
      case 'indigenous-knowledge-integration-and-fpic-2.0': return '🌿';
      case 'cultural-evolution-and-adaptive-practices': return '🎭';
      case 'technology-intergation-and-digital-sovereignty': return '💻';
      default: return '⚖️';
    }
  }
...
<svelte:head>
  <title>Balancing Innovation & Tradition - Bioregional Compass</title>
  <meta name="description" content="Frameworks for integrating new technologies and approaches while honoring traditional wisdom and cultural continuity" />
</svelte:head>
...
{#if mounted}
  ...
  <div class="breadcrumb-nav">
    <nav class="breadcrumb-container">
      ...
      <span class="breadcrumb-separator">›</span>
      <span class="breadcrumb-current">Innovation & Tradition</span>
    </nav>
  </div>
    ...
    <header class="playbook-header">
      <div class="header-content">
        ...
        <p class="playbook-description">
          Frameworks for integrating new technologies and approaches while honoring traditional wisdom and cultural continuity
        </p>
    ...
    <div class="content-layout">
      ...
      <aside class="section-nav" class:expanded={sidebarExpanded}>
        <div class="nav-header">
          <h2 class="nav-title">Integration Frameworks</h2>
...
{:else}
  ...
  <div class="loading-container">
    ...
    <p>Loading innovation & tradition playbook...</p>
  </div>
{/if}

<style>
  /* Innovation & tradition color scheme */
  :root {
    --guide-primary: #2D5016;
    --guide-secondary: #8B5A2B;
    --guide-accent: #CD853F;
    --guide-light: #F5F5DC;
    --adaptation-primary: #008080; /* Teal for balance/adaptation */
    --adaptation-secondary: #20B2AA; /* Light sea green */
    --adaptation-light: rgba(0, 128, 128, 0.1);
  }
  ...
  /* Playbook Header */
  .playbook-header {
    background: linear-gradient(135deg, var(--guide-light), var(--adaptation-light));
    border-radius: 1rem;
    padding: 3rem 2rem;
    margin-bottom: 3rem;
  ...
  .category-badge.adaptation {
    background: var(--adaptation-primary);
    color: white;
  }
  ...
  .section-btn:hover {
    background-color: var(--adaptation-light);
    border-color: var(--adaptation-primary);
  }
  ...
  .markdown-content :global(h1) {
    ...
    margin: 0 0 1.5rem 0;
    line-height: 1.2;
    border-bottom: 3px solid var(--adaptation-primary);
  ...
  .markdown-content :global(a:hover) {
    color: var(--adaptation-secondary);
  ...
  .markdown-content :global(blockquote) {
    margin: 1.5rem 0;
    padding: 1rem 1.5rem;
    border-left: 4px solid var(--adaptation-primary);
    background: var(--adaptation-light);
    border-radius: 0 0.5rem 0.5rem 0;
  }

  .markdown-content :global(.adaptation) {
    margin: 1.5rem 0;
