<!-- src/routes/frameworks/guides/bioregional-compass/playbooks/culture-war-mitigation-and-external-communication/+page.svelte -->
<script>
  ...
  function getSectionIcon(sectionId) {
    switch (sectionId) {
      ...
      case 'narrative-strategy-and-framing': return '📝';
      case 'bridge-building-and-coalition-development': return '🌉';
      case 'crisis-communication-and-reputation-management': return '📢';
      default: return '📡';
    }
  }
...
<svelte:head>
  <title>Culture War Mitigation & External Communication - Bioregional Compass</title>
  <meta name="description" content="Communication strategies and narrative frameworks for navigating polarized environments and hostile public discourse" />
</svelte:head>
...
{#if mounted}
  ...
  <div class="breadcrumb-nav">
    <nav class="breadcrumb-container">
      ...
      <span class="breadcrumb-separator">›</span>
      <span class="breadcrumb-current">Culture War Mitigation</span>
    </nav>
  </div>
    ...
    <header class="playbook-header">
      <div class="header-content">
        ...
        <p class="playbook-description">
          Communication strategies and narrative frameworks for navigating polarized environments and hostile public discourse
        </p>
    ...
    <div class="content-layout">
      ...
      <aside class="section-nav" class:expanded={sidebarExpanded}>
        <div class="nav-header">
          <h2 class="nav-title">Communication Strategies</h2>
...
{:else}
  ...
  <div class="loading-container">
    ...
    <p>Loading culture war mitigation playbook...</p>
  </div>
{/if}

<style>
  /* Culture war mitigation color scheme */
  :root {
    --guide-primary: #2D5016;
    --guide-secondary: #8B5A2B;
    --guide-accent: #CD853F;
    --guide-light: #F5F5DC;
    --communication-primary: #FF6347; /* Tomato for communication/media */
    --communication-secondary: #FF7F50; /* Coral */
    --communication-light: rgba(255, 99, 71, 0.1);
  }
  ...
  /* Playbook Header */
  .playbook-header {
    background: linear-gradient(135deg, var(--guide-light), var(--communication-light));
    border-radius: 1rem;
    padding: 3rem 2rem;
    margin-bottom: 3rem;
  ...
  .category-badge.relationships {
    background: var(--communication-primary);
    color: white;
  }
  ...
  .stat-number {
    font-size: 1.5rem;
    font-weight: 700;
    color: var(--communication-primary);
  }
  ...
  .section-btn:hover {
    background-color: var(--communication-light);
    border-color: var(--communication-primary);
  }
  ...
  .markdown-content :global(h1) {
    ...
    margin: 0 0 1.5rem 0;
    line-height: 1.2;
    border-bottom: 3px solid var(--communication-primary);
  ...
  .markdown-content :global(a:hover) {
    color: var(--communication-secondary);
  ...
  .markdown-content :global(.communication) {
    margin: 1.5rem 0;
