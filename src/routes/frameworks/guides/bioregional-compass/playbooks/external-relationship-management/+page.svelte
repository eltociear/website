<!-- src/routes/frameworks/guides/bioregional-compass/playbooks/external-relationship-management/+page.svelte -->
<script>
  ...
  function getSectionIcon(sectionId) {
    switch (sectionId) {
      ...
      case 'municipal-government-and-public-agency-relations': return '🏛️';
      case 'utility-providers-and-infrastructure-partnerships': return '⚡';
      case 'regional-economic-integration-and-business-networks': return '🏭';
      default: return '🤝';
    }
  }
...
<svelte:head>
  <title>External Relationship Management - Bioregional Compass</title>
  <meta name="description" content="Strategic frameworks for building and maintaining relationships with external stakeholders, institutions, and communities" />
</svelte:head>
...
{#if mounted}
  ...
  <div class="breadcrumb-nav">
    <nav class="breadcrumb-container">
      ...
      <span class="breadcrumb-separator">›</span>
      <span class="breadcrumb-current">External Relationship Management</span>
    </nav>
  </div>
    ...
    <header class="playbook-header">
      <div class="header-content">
        ...
        <p class="playbook-description">
          Strategic frameworks for building and maintaining relationships with external stakeholders, institutions, and communities
        </p>
    ...
    <div class="content-layout">
      ...
      <aside class="section-nav" class:expanded={sidebarExpanded}>
        <div class="nav-header">
          <h2 class="nav-title">Relationship Areas</h2>
...
{:else}
  ...
  <div class="loading-container">
    ...
    <p>Loading external relationship management playbook...</p>
  </div>
{/if}

<style>
  /* External relationship management color scheme */
  :root {
    --guide-primary: #2D5016;
    --guide-secondary: #8B5A2B;
    --guide-accent: #CD853F;
    --guide-light: #F5F5DC;
    --relationships-primary: #9932CC; /* Dark orchid for relationships */
    --relationships-secondary: #BA55D3; /* Medium orchid */
    --relationships-light: rgba(153, 50, 204, 0.1);
  }
  ...
  /* Playbook Header */
  .playbook-header {
    background: linear-gradient(135deg, var(--guide-light), var(--relationships-light));
    border-radius: 1rem;
    padding: 3rem 2rem;
    margin-bottom: 3rem;
  ...
  .category-badge.relationships {
    background: var(--relationships-primary);
    color: white;
  }
  ...
  .stat-number {
    font-size: 1.5rem;
    font-weight: 700;
    color: var(--relationships-primary);
  }
  ...
  .section-btn:hover {
    background-color: var(--relationships-light);
    border-color: var(--relationships-primary);
  }
  ...
  .markdown-content :global(h1) {
    ...
    margin: 0 0 1.5rem 0;
    line-height: 1.2;
    border-bottom: 3px solid var(--relationships-primary);
  ...
  .markdown-content :global(a:hover) {
    color: var(--relationships-secondary);
  ...
  .markdown-content :global(blockquote) {
    margin: 1.5rem 0;
    padding: 1rem 1.5rem;
    border-left: 4px solid var(--relationships-primary);
    background: var(--relationships-light);
    border-radius: 0 0.5rem 0.5rem 0;
  }

  .markdown-content :global(.relationships) {
    margin: 1.5rem 0;
