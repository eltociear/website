<!-- src/routes/frameworks/guides/bioregional-compass/playbooks/technology-integration-and-resilience/+page.svelte -->
<script>
  ...
  function getSectionIcon(sectionId) {
    switch (sectionId) {
      ...
      case 'appropriate-technology-assessment-and-selection': return '🔍';
      case 'digital-sovereignty-and-data-protection': return '🔒';
      case 'technology-resilience-and-backup-systems': return '🔧';
      default: return '💻';
    }
  }
...
<svelte:head>
  <title>Technology Integration & Resilience - Bioregional Compass</title>
  <meta name="description" content="Strategic approaches to technology adoption, digital sovereignty, and maintaining technological resilience in BAZ communities" />
</svelte:head>
...
{#if mounted}
  ...
  <div class="breadcrumb-nav">
    <nav class="breadcrumb-container">
      ...
      <span class="breadcrumb-separator">›</span>
      <span class="breadcrumb-current">Technology Integration</span>
    </nav>
  </div>
    ...
    <header class="playbook-header">
      <div class="header-content">
        <div class="playbook-meta">
          <span class="category-badge adaptation">Innovation & Adaptation</span>
        ...
        <p class="playbook-description">
          Strategic approaches to technology adoption, digital sovereignty, and maintaining technological resilience in BAZ communities
        </p>
    ...
    <div class="content-layout">
      ...
      <aside class="section-nav" class:expanded={sidebarExpanded}>
        <div class="nav-header">
          <h2 class="nav-title">Technology Systems</h2>
...
{:else}
  ...
  <div class="loading-container">
    ...
    <p>Loading technology integration playbook...</p>
  </div>
{/if}

<style>
  /* Technology integration color scheme */
  :root {
    --guide-primary: #2D5016;
    --guide-secondary: #8B5A2B;
    --guide-accent: #CD853F;
    --guide-light: #F5F5DC;
    --technology-primary: #6366F1; /* Indigo for technology */
    --technology-secondary: #8B5CF6; /* Violet */
    --technology-light: rgba(99, 102, 241, 0.1);
  }
  ...
  /* Playbook Header */
  .playbook-header {
    background: linear-gradient(135deg, var(--guide-light), var(--technology-light));
    border-radius: 1rem;
    padding: 3rem 2rem;
    margin-bottom: 3rem;
  ...
  .category-badge.adaptation {
    background: var(--technology-primary);
    color: white;
  }
  ...
  .section-btn:hover {
    background-color: var(--technology-light);
    border-color: var(--technology-primary);
  }
  ...
  .markdown-content :global(h1) {
    ...
    margin: 0 0 1.5rem 0;
    line-height: 1.2;
    border-bottom: 3px solid var(--technology-primary);
  ...
  .markdown-content :global(a:hover) {
    color: var(--technology-secondary);
  ...
  .markdown-content :global(blockquote) {
    margin: 1.5rem 0;
    padding: 1rem 1.5rem;
    border-left: 4px solid var(--technology-primary);
    background: var(--technology-light);
    border-radius: 0 0.5rem 0.5rem 0;
  }

  .markdown-content :global(.technology) {
    margin: 1.5rem 0;
