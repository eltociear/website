<!-- src/routes/frameworks/guides/bioregional-compass/playbooks/legal-challenge-scenarios-and-mitigations/+page.svelte -->
<script>
  ...
  function getSectionIcon(sectionId) {
    switch (sectionId) {
      ...
      case 'regulatory-and-compliance-challenges': return '📄';
      case 'financial-and-tax-compliance-issues': return '💰';
      case 'emergency-services-and-crisis-response': return '🚨';
      default: return '⚖️';
    }
  }
...
<svelte:head>
  <title>Legal Challenge Scenarios & Mitigations - Bioregional Compass</title>
  <meta name="description" content="Detailed scenarios and response strategies for common legal challenges faced by BAZ communities, with practical mitigation approaches" />
</svelte:head>
...
{#if mounted}
  ...
  <div class="breadcrumb-nav">
    <nav class="breadcrumb-container">
      ...
      <span class="breadcrumb-separator">›</span>
      <span class="breadcrumb-current">Legal Challenge Scenarios</span>
    </nav>
  </div>
    ...
    <header class="playbook-header">
      <div class="header-content">
        <div class="playbook-meta">
          <span class="category-badge legal">Legal & Regulatory</span>
        ...
        <p class="playbook-description">
          Detailed scenarios and response strategies for common legal challenges faced by BAZ communities, with practical mitigation approaches
        </p>
        ...
        <div class="playbook-stats">
          ...
          <div class="stat-item">
            ...
            <span class="stat-number">1-2 weeks</span>
          </div>
          <div class="stat-item">
    ...
    <div class="content-layout">
      ...
      <aside class="section-nav" class:expanded={sidebarExpanded}>
        <div class="nav-header">
          <h2 class="nav-title">Challenge Scenarios</h2>
...
{:else}
  ...
  <div class="loading-container">
    ...
    <p>Loading legal challenge scenarios...</p>
  </div>
{/if}

<style>
  /* Legal challenges color scheme */
  :root {
    --guide-primary: #2D5016;
    --guide-secondary: #8B5A2B;
    --guide-accent: #CD853F;
    --guide-light: #F5F5DC;
    --legal-primary: #8B0000;
    --legal-secondary: #DC143C;
    --legal-light: rgba(139, 0, 0, 0.1);
    --scenario-primary: #B8860B; /* Dark goldenrod for scenarios */
    --scenario-secondary: #DAA520; /* Goldenrod */
    --scenario-light: rgba(184, 134, 11, 0.1);
  }
  ...
  /* Playbook Header */
  .playbook-header {
    background: linear-gradient(135deg, var(--guide-light), var(--scenario-light));
    border-radius: 1rem;
    padding: 3rem 2rem;
    margin-bottom: 3rem;
  ...
  .section-btn:hover {
    background-color: var(--scenario-light);
    border-color: var(--scenario-primary);
  }
  ...
  .markdown-content :global(h1) {
    ...
    margin: 0 0 1.5rem 0;
    line-height: 1.2;
    border-bottom: 3px solid var(--scenario-primary);
  ...
  .markdown-content :global(blockquote) {
    margin: 1.5rem 0;
    padding: 1rem 1.5rem;
    border-left: 4px solid var(--scenario-primary);
    background: var(--scenario-light);
    border-radius: 0 0.5rem 0.5rem 0;
  }

  .markdown-content :global(.scenario) {
    margin: 1.5rem 0;
