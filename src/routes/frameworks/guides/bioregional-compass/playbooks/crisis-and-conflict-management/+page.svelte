<!-- src/routes/frameworks/guides/bioregional-compass/playbooks/crisis-and-conflict-management/+page.svelte -->
<script>
  ...
  function getSectionIcon(sectionId) {
    switch (sectionId) {
      ...
      case 'internal-conflict-resolution-and-transformation': return '🤝';
      case 'external-pressure-management-and-diplomatic-relations': return '🛡️';
      case 'system-resilience-and-crisis-response': return '🔧';
      default: return '⚡';
    }
  }
...
<svelte:head>
  <title>Crisis & Conflict Management - Bioregional Compass</title>
  <meta name="description" content="Comprehensive approaches to crisis response, conflict resolution, and community resilience during challenging periods" />
</svelte:head>
...
{#if mounted}
  ...
  <div class="breadcrumb-nav">
    <nav class="breadcrumb-container">
      ...
      <span class="breadcrumb-separator">›</span>
      <span class="breadcrumb-current">Crisis & Conflict Management</span>
    </nav>
  </div>
    ...
    <header class="playbook-header">
      <div class="header-content">
        ...
        <p class="playbook-description">
          Comprehensive approaches to crisis response, conflict resolution, and community resilience during challenging periods
        </p>
        
        <div class="playbook-stats">
          <div class="stat-item">
            <span class="stat-label">Approaches</span>
    ...
    <div class="content-layout">
      ...
      <aside class="section-nav" class:expanded={sidebarExpanded}>
        <div class="nav-header">
          <h2 class="nav-title">Crisis Management</h2>
...
{:else}
  ...
  <div class="loading-container">
    ...
    <p>Loading crisis & conflict management playbook...</p>
  </div>
{/if}

<style>
  /* Crisis & conflict management color scheme */
  :root {
    --guide-primary: #2D5016;
    --guide-secondary: #8B5A2B;
    --guide-accent: #CD853F;
    --guide-light: #F5F5DC;
    --crisis-primary: #DC143C; /* Crimson for crisis/emergency */
    --crisis-secondary: #FF4500; /* Orange red */
    --crisis-light: rgba(220, 20, 60, 0.1);
  }
  ...
  /* Playbook Header */
  .playbook-header {
    background: linear-gradient(135deg, var(--guide-light), var(--crisis-light));
    border-radius: 1rem;
    padding: 3rem 2rem;
    margin-bottom: 3rem;
  ...
  .section-btn:hover {
    background-color: var(--crisis-light);
    border-color: var(--crisis-primary);
  }

  .section-btn.active {
    background: var(--crisis-secondary);
    border-color: var(--crisis-secondary);
    color: white;
  }
  ...
  .markdown-content :global(h1) {
    ...
    margin: 0 0 1.5rem 0;
    line-height: 1.2;
    border-bottom: 3px solid var(--crisis-primary);
  ...
  .markdown-content :global(blockquote) {
    margin: 1.5rem 0;
    padding: 1rem 1.5rem;
    border-left: 4px solid var(--crisis-primary);
    background: var(--crisis-light);
    border-radius: 0 0.5rem 0.5rem 0;
  }

  .markdown-content :global(.crisis) {
    margin: 1.5rem 0;
