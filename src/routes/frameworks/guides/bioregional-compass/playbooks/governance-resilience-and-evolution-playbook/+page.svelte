<!-- src/routes/frameworks/guides/bioregional-compass/playbooks/governance-resilience-and-evolution-playbook/+page.svelte -->
<script>
  ...
  function getSectionIcon(sectionId) {
    switch (sectionId) {
      ...
      case 'decision-making-systems-and-deadlock-resolution': return '⚖️';
      case 'power-dynamics-and-accountability-systems': return '🔍';
      case 'succession-planning-and-institutional-memory': return '📚';
      default: return '🏛️';
    }
  }
...
<svelte:head>
  <title>Governance Resilience & Evolution Playbook - Bioregional Compass</title>
  <meta name="description" content="Advanced strategies for maintaining effective governance during crises, managing power dynamics, and evolving governance systems" />
</svelte:head>
...
{#if mounted}
  ...
  <div class="breadcrumb-nav">
    <nav class="breadcrumb-container">
      ...
      <span class="breadcrumb-separator">›</span>
      <span class="breadcrumb-current">Governance Resilience</span>
    </nav>
  </div>
    ...
    <header class="playbook-header">
      <div class="header-content">
        ...
        <p class="playbook-description">
          Advanced strategies for maintaining effective governance during crises, managing power dynamics, and evolving governance systems
        </p>
    ...
    <div class="content-layout">
      ...
      <aside class="section-nav" class:expanded={sidebarExpanded}>
        <div class="nav-header">
          <h2 class="nav-title">Governance Systems</h2>
...
{:else}
  ...
  <div class="loading-container">
    ...
    <p>Loading governance resilience playbook...</p>
  </div>
{/if}

<style>
  /* Governance playbook color scheme */
  :root {
    --guide-primary: #2D5016;
    --guide-secondary: #8B5A2B;
    --guide-accent: #CD853F;
    --guide-light: #F5F5DC;
    --governance-primary: #4169E1; /* Royal blue for governance */
    --governance-secondary: #6495ED; /* Cornflower blue */
    --governance-light: rgba(65, 105, 225, 0.1);
  }
  ...
  /* Playbook Header */
  .playbook-header {
    background: linear-gradient(135deg, var(--guide-light), var(--governance-light));
    border-radius: 1rem;
    padding: 3rem 2rem;
    margin-bottom: 3rem;
  ...
  .section-btn:hover {
    background-color: var(--governance-light);
    border-color: var(--governance-primary);
  }
  ...
  .markdown-content :global(h1) {
    ...
    margin: 0 0 1.5rem 0;
    line-height: 1.2;
    border-bottom: 3px solid var(--governance-primary);
  ...
  .markdown-content :global(a:hover) {
    color: var(--governance-secondary);
  ...
  .markdown-content :global(blockquote) {
    margin: 1.5rem 0;
    padding: 1rem 1.5rem;
    border-left: 4px solid var(--governance-primary);
    background: var(--governance-light);
