<!-- src/routes/frameworks/guides/bioregional-compass/playbooks/diplomatic-playbook/+page.svelte -->
<script>
  ...
  function getSectionIcon(sectionId) {
    switch (sectionId) {
      ...
      case 'engaging-state-actors-and-government-relations': return '🏛️';
      case 'hostile-jurisdictions-and-legal-defense': return '🛡️';
      case 'network-diplomacy-and-alliance-building': return '🌐';
      default: return '🤝';
    }
  }
...
<svelte:head>
  <title>Diplomatic Playbook - Bioregional Compass</title>
  <meta name="description" content="Advanced diplomatic strategies for engaging with government entities, hostile jurisdictions, and complex political environments" />
</svelte:head>
...
{#if mounted}
  ...
  <div class="breadcrumb-nav">
    <nav class="breadcrumb-container">
      ...
      <span class="breadcrumb-separator">›</span>
      <span class="breadcrumb-current">Diplomatic Playbook</span>
    </nav>
  </div>
    ...
    <header class="playbook-header">
      <div class="header-content">
        <div class="playbook-meta">
          <span class="category-badge relationships">External Relations & Communication</span>
        ...
        <p class="playbook-description">
          Advanced diplomatic strategies for engaging with government entities, hostile jurisdictions, and complex political environments
        </p>
    ...
    <div class="content-layout">
      ...
      <aside class="section-nav" class:expanded={sidebarExpanded}>
        <div class="nav-header">
          <h2 class="nav-title">Diplomatic Strategies</h2>
...
{:else}
  ...
  <div class="loading-container">
    ...
    <p>Loading diplomatic playbook...</p>
  </div>
{/if}

<style>
  /* Diplomatic playbook color scheme */
  :root {
    --guide-primary: #2D5016;
    --guide-secondary: #8B5A2B;
    --guide-accent: #CD853F;
    --guide-light: #F5F5DC;
    --diplomatic-primary: #2F4F4F; /* Dark slate gray for diplomacy */
    --diplomatic-secondary: #708090; /* Slate gray */
    --diplomatic-light: rgba(47, 79, 79, 0.1);
    --diplomatic-accent: #4682B4; /* Steel blue */
  }
  ...
  /* Playbook Header */
  .playbook-header {
    background: linear-gradient(135deg, var(--guide-light), var(--diplomatic-light));
    border-radius: 1rem;
    padding: 3rem 2rem;
    margin-bottom: 3rem;
  ...
  .category-badge.relationships {
    background: var(--diplomatic-primary);
    color: white;
  }

  .difficulty-badge.advanced {
    background: var(--diplomatic-accent);
    color: white;
  }
  ...
  .section-btn:hover {
    background-color: var(--diplomatic-light);
    border-color: var(--diplomatic-primary);
  }

  .section-btn.active {
    background: var(--diplomatic-secondary);
    border-color: var(--diplomatic-secondary);
    color: white;
  }
  ...
  .markdown-content :global(h1) {
    ...
    margin: 0 0 1.5rem 0;
    line-height: 1.2;
    border-bottom: 3px solid var(--diplomatic-primary);
  ...
  .markdown-content :global(blockquote) {
    margin: 1.5rem 0;
    padding: 1rem 1.5rem;
    border-left: 4px solid var(--diplomatic-primary);
    background: var(--diplomatic-light);
    border-radius: 0 0.5rem 0.5rem 0;
  }

  .markdown-content :global(.diplomatic) {
    margin: 1.5rem 0;
