...
export async function load({ depends, url, params }) {
  ...
  if (DEBUG_FRAMEWORK_LOADING) console.log('=== Kinship Protocol +page.js load function ===');
  ...
  if (DEBUG_FRAMEWORK_LOADING) console.log('Loading kinship protocol sections for locale:', currentLocale);
