...
<script>
  ...
  const sections = [
    ...
    { id: 'assessment', name: 'Context Assessment', icon: '📊' },
    { id: 'journeys', name: 'Journey Selection', icon: '🗺️' },
    { id: 'tools', name: 'Tool Database', icon: '🔧' },
    { id: 'stacks', name: 'Tool Stacks', icon: '📦' },
    { id: 'guidance', name: 'Implementation Guidance', icon: '💡' },
    { id: 'appendices', name: 'Appendices', icon: '📚' }
  ];
    ...
    if (typeof localStorage !== 'undefined') {
      ...
      if (saved) {
        try {
          ...
          console.warn('Failed to parse saved assessment:', e);
        }
      }
    }
  ...
  // Helper function to safely display markdown content
                    ...
                    <div class="step-item">
                      ...
                      <div class="step-content">
                        ...
                        <button class="step-action" on:click={() => selectSection('assessment')}>
                          {commonT_helper('ui.startAssessment', 'Start Assessment')} →
                        </button>
                      </div>
                    </div>
                    ...
                    <div class="step-item">
                      ...
                      <div class="step-content">
                        ...
                        <button class="step-action" on:click={() => selectSection('journeys')}>
                          {commonT_helper('ui.exploreJourneys', 'Explore Journeys')} →
                        </button>
                      </div>
                    </div>
                    ...
                    <div class="step-item">
                      ...
                      <div class="step-content">
                        ...
                        <button class="step-action" on:click={() => selectSection('tools')}>
                          {commonT_helper('ui.browseTools', 'Browse Tools')} →
                        </button>
                      </div>
                    </div>
                  </div>
            ...
            <div class="section-sidebar">
              ...
              <div class="info-card">
                ...
                <a href="{base}/get-involved" class="info-link">
                  {commonT_helper('ui.learnMore', 'Learn More')} →
                </a>
              </div>
            </div>
          </div>
                ...
                <div class="recommendation">
                  ...
                  <div class="recommended-stack">
                    ...
                    <div class="stack-meta">
                      <span class="meta-item">⏱️ {recommendedStack.timeframe}</span>
                      <span class="meta-item">💰 {recommendedStack.resources}</span>
                    </div>
                    <button class="view-stack-button" on:click={() => selectSection('stacks')}>
                      {$t('common.ui.viewToolStack', 'View Tool Stack')} →
                    </button>
                  </div>
                </div>
              {/if}
      ...
      {#if currentSection === 'tools'}
        ...
        <section class="content-section tools-section">
          ...
          {#if content?.sections?.['tool-database']}
            <div class="markdown-content">
              <h3>🔧 Tool Database Methodology</h3>
