...
export async function load({ depends, url, params }) {
  ...
  if (DEBUG_FRAMEWORK_LOADING) console.log('=== Deep Time Governance +page.js load function ===');
  ...
  if (DEBUG_FRAMEWORK_LOADING) console.log('Loading deep time governance sections for locale:', currentLocale);
