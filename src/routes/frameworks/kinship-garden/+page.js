...
export async function load({ depends, url, params }) {
  ...
  if (DEBUG_FRAMEWORK_LOADING) console.log('=== kinship-garden +page.js load function ===');
  ...
  if (DEBUG_FRAMEWORK_LOADING) console.log('Loading kinship-garden sections for locale:', currentLocale);
