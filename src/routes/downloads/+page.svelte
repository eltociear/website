      ...
      <div class="card-grid">
        ...
        <div class="download-card">
          ...
          <div class="card-content">
            ...
            <button on:click={(e) => handleDownload(e, 'Climate-And-Energy-Governance-Framework')} class="download-button" style="background-color: #2C8A78;">
              {$t('downloads.downloadButton')}
              <svg xmlns="http://www.w3.org/2000/svg" class="download-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
              </svg>
        ...
        <div class="download-card" style="background-color: #f0f8ff; border: 1px solid #00a5b5;">
          <div class="card-emoji" style="color: #0b4b66;">🌊</div>
          <div class="card-content">
            <h2 class="card-title" style="color: #0b4b66;">{$t('downloads.implementationFrameworks.oceansMarineGovernance.title')}</h2>
            <p class="card-description">{$t('downloads.implementationFrameworks.oceansMarineGovernance.description')}</p>
            <button on:click={(e) => handleDownload(e, 'Oceans-And-Marine-Governance-Framework')} class="download-button" style="background-color: #0b4b66;">
              {$t('downloads.downloadButton')}
              <svg xmlns="http://www.w3.org/2000/svg" class="download-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
              </svg>
        ...
        <div class="download-card" style="background-color: #eff6ff; border: 1px solid #3b82f6;">
          <div class="card-emoji" style="color: #1E3A8A;">🚆</div>
          <div class="card-content">
            <h2 class="card-title" style="color: #1E3A8A;">{$t('downloads.implementationFrameworks.mobilityCommons.title')}</h2>
            <p class="card-description">{$t('downloads.implementationFrameworks.mobilityCommons.description')}</p>
            <button on:click={(e) => handleDownload(e, 'Mobility-Commons-Framework')} class="download-button" style="background-color: #1E3A8A;">
              {$t('downloads.downloadButton')}
              <svg xmlns="http://www.w3.org/2000/svg" class="download-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
              </svg>
