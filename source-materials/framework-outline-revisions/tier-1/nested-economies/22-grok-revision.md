...
- **Version History**:
  - **3.0 (2025-09-03)**: Clarified unique role as economic subsidiarity framework; removed redundant AUBI details with cross-references; separated Love Ledger from Hearts mechanisms; updated Quick Start Guide to BAZ Starter Pack; enhanced governance roles.
...
- **Key Principles** (color-coded):
  ...
  - <span style="color: red;">Resource Justice</span>: Equitable access via the **AUBI Framework** and its **Hearts/Leaves** currencies.
...
- **Quick Start Guide**:
  1. Form a Convening Circle.
  2. Establish a Proto-Treasury.
  3. Recruit Community Providers.
  4. Formalize a BAZ Council.

---

## 2. Core Economic Integration Principles
### 2.1 Nested Economic Systems
- **Local**: Community-driven care economies using **Hearts** and **Leaves**, with informal care contributions recognized by the parallel **Love Ledger** system. This level involves chartered **Community Providers** delivering formal services redeemable for **Hearts**, supported by **Community Weavers** for on-the-ground facilitation, and stabilized by the **Hearts Treasury** (`mechanism_hearts_treasury`).
...
- **Equitable Access**: Resource justice is primarily delivered through the four-layered payout architecture of the **AUBI Framework v5.0**, which provides a universal baseline and equitable bonuses.
...
- **Case Study**:...(truncated 346 characters)...
...
- **AUBI Payout Architecture**: Resource justice is primarily delivered through the four-layered payout architecture of the **AUBI Framework v5.0**, which provides a universal baseline and equitable bonuses.
...
- **Mandate**: The **Social Resilience Council** oversees **Hearts** supply management, stakeholder coordination across local, regional, and global levels, and ethical oversight of the economic ecosystem, ensuring alignment with AUBI and Right Relationship principles. The Fractal Labor Parliament sets work valuation standards, distinct from the Council’s coordination and oversight roles. The **Social Resilience Council** sets global standards and manages the GCF, while local **BAZ Councils** are responsible for chartering Community Providers and managing the day-to-day governance of their nested Hearts economy.
