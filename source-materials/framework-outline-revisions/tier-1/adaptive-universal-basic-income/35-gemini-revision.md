# **Adaptive Universal Basic Income (AUBI) Framework v6.0**

---

### **Tier:** 1 (Foundational Social Framework)
### **Status:** Revision 7.0 - Indigenous-Guided, Treaty-Integrated Synthesis
### **Revision:** 7.0 (2025-11-05)
...
### **Version History:**
- **7.1 (2025-12-09):** Security Patch
- **7.0 (2025-11-05):** Aligned with Maria Karlova's analysis of the parasistic control system of civilization.
- **6.0 (2025-09-03):** Aligned with "The Currency of Care" white paper: Introduced dual system of monetized Hearts economy and non-monetized Love Ledger; restructured payout architecture to separate Love Ledger from Hearts verification; added Hearts Treasury subsection; integrated Grassroots Bootstrapping Pathway; enhanced Community Weavers details.
...
**Transition Strategy:** LMCI complements GDP for 5 years, with studies showing 7-12% productivity gains from enhanced autonomy and flourishing.
...
- **Purpose:** Rewards contributions to LMCI pillars, paid in Hearts. Contribution Bonus as **Dignity Restoration** - explicitly rewarding the work that capitalism devalues but human flourishing requires. This systematically dismantles shame programming around 'unproductive' activities.
- **Contributions:**
...
Outline the four-step process from "The Currency of Care":
    1.  **The Convening Circle:** A small group starts a concrete pilot project.
    2.  **The Proto-Treasury:** A simple, shared bank account to prove the concept.
    3.  **Provider Recruitment:** The circle expands by recruiting other local providers.
    4.  **Governance Formalization:** A **BAZ Council** (`institution_baz_council`) is elected only after the model shows initial success.
    5.  **Explicit Outreach to Marginalized Communities:** The formalized BAZ Council has a mandated role to proactively identify and include stateless, nomadic, and homeless individuals within its bioregion, using the **Community Attestation** and **Mobile Registration** protocols. Success metrics for the BAZ include the percentage of its most marginalized residents enrolled in AUBI.
